...
module.exports.putChannelRequest.resolve = function resolvePutChannelRequest({ channel, message }, io, engine, parentTask, cb) {
  const id = channel.putRequest(message);
  parentTask.running && cb(null, id);
};
...
module.exports.takeChannelRequest.resolve = function resolveTakeChannelRequest({ channel }, io, engine, parentTask, cb) {
  channel.takeRequest((request) => {
    parentTask.running && cb(null, request);
  });
};
 ...
 */
module.exports.putChannelResponse = function describePutChannelResponse(channel, id, response) {
  return {
...
module.exports.putChannelResponse.resolve = function resolvePutChannelResponse({ channel, id, response }, io, engine, parentTask, cb) {
  channel.putResponse(id, response);
  parentTask.running && cb(null, id);
};
...
module.exports.takeChannelResponse.resolve = function resolveTakeChannelResponse({ channel, requestId }, io, engine, parentTask, cb) {
  channel.takeResponse(requestId, (response) => {
    parentTask.running && cb(null, response);
  });
};
